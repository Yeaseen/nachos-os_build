...
StartProcess(const char *filename)
{
    ...
    swapMemoryManager = new memorymanager(SWAPSIZE);
    swapSpace = new SwapSpace[SWAPSIZE];
    processTable = new processtable(20);
    ...
    currentThread->process_id=processTable->Alloc((void*)currentThread);
